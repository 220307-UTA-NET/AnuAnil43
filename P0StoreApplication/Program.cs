...
namespace  StoreApplication
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int[] quantity = new int[25] { 5, 10, 5, 4, 4, 2, 2, 5, 4, 3, 4, 3, 5, 6, 3, 8, 9, 1, 4, 3, 6, 4, 7, 4, 6 };
...
while(!input1.ToLower().Equals("p"))
{
    Console.WriteLine("Enter the number of the product");
    input1 = Console.ReadLine();
    Console.WriteLine("Enter the Quantity");
    input2 = Console.ReadLine();
    if(Int32.TryParse(input1, out choice))
    {
        choice = choice-1;
    ...
    else if(input1.ToLower().Equals("p"))
    {
        break;
    }
    else
